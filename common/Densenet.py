...
def densenet121(pretrained=False, **kwargs):
    ...
    """
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(2, 2, 2, 2),
                     **kwargs)
    if pretrained:
...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.add_module('LeakyReLU.1', nn.LeakyReLU(0.2, inplace=True)),
        self.add_module('conv.1', nn.Conv2d(num_input_features, bn_size *
                        growth_rate, kernel_size=1, stride=1, bias=False)),
        self.add_module('norm.2', nn.BatchNorm2d(bn_size * growth_rate)),
        self.add_module('LeakyReLU.2', nn.LeakyReLU(0.2, inplace=True)),
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ...
            ('LeakyReLU0', nn.LeakyReLU(0.2, inplace=True)),
